...
import com.cb.yash.java8_steam_api.stream_api.task4.ListToSet;
...
public class Test {
    public static void main(String[] args) {
        ...
        Item item2 = new Item(106, "laptop i2",
        ...
        List<Item> itemList = Arrays.asList(item5, item, item3, item1, item4, item2);
        RemoveDuplicatePrice.removeDuplicatePrice(itemList);
    }
}
